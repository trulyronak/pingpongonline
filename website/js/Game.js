...
import { sendPlayerMovement, socket, roomName, playerName, setPrimary } from "./socket";
      ...
      this.canvas.addEventListener(
        ...
        (evt) => {
          if (this.isStarted) {
            ...
            sendPlayerMovement(evt.clientX / this.canvas.width, evt.clientY / this.canvas.height, this.canvas.width, this.canvas.height);
